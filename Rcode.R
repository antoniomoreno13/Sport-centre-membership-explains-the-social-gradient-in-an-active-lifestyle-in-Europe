...
model1a <- glm(WHO_prev ~ Age + Gender + Sizeofcommunity + Education_3cat_recod, data = eu2017, family = binomial, na.action = na.exclude)
model1b <- glm(WHO_prev ~ Age + Gender + Sizeofcommunity + Education_3cat_recod + ALL_Sport_centres_venue, data = eu2017, family = binomial, na.action = na.exclude)

model2a <- glm(WHO_prev ~ Age + Gender + Sizeofcommunity + Ocupation_3cat, data = eu2017, family = binomial, na.action = na.exclude)
model2b <- glm(WHO_prev ~ Age + Gender + Sizeofcommunity + Ocupation_3cat + ALL_Sport_centres_venue, data = eu2017, family = binomial, na.action = na.exclude)

model3a <- glm(WHO_prev ~ Age + Gender + Sizeofcommunity + Bills, data = eu2017, family = binomial, na.action = na.exclude)
model3b <- glm(WHO_prev ~ Age + Gender + Sizeofcommunity + Bills + ALL_Sport_centres_venue, data = eu2017, family = binomial, na.action = na.exclude)
